...
q8 = Question.create({
    title: "Styled components onClick rotate element",
    body: "I'm trying to add a rotation to an element when clicked. Each time I want to click on the element the element should rotate. I'm rotating the",
    tag: "rails",
    user: u4
    })
